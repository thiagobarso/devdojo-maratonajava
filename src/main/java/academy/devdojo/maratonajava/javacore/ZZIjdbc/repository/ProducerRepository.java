...
public class ProducerRepository {
    ...
    private static PreparedStatement preparedStatamentUpdate(Connection conn, Producer producer) throws SQLException {
...
//                rs.cancelRowUpdates();
    ...
    public static List<Producer> findByNamePreparedStatement(String name) {
        log.info("Finding producers by name with prepared statement '{}'", name);
        List<Producer> producers = new ArrayList<>();
        try (Connection conn = ConnectionFactory.getConnection();
             PreparedStatement ps = preparedStatamentFindByName(conn, name);
    ...
    private static PreparedStatement preparedStatamentFindByName(Connection conn, String name) throws SQLException {
    ...
    private static CallableStatement callableStatamentFindByName(Connection conn, String name) throws SQLException {
        String sql = "CALL `anime_store`.`sp_get_producer`(?);";
