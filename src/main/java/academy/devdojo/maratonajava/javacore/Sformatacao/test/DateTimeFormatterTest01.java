...
public class DateTimeFormatterTest01 {
    public static void main(String[] args) {
        ...
        LocalDateTime parse4 = LocalDateTime.parse("2024-09-11T09:57:33.128651635", DateTimeFormatter.ISO_DATE_TIME);
        ...
        LocalDate parserBR = LocalDate.parse("19/02/2021", formatterBR);
        System.out.println(parserBR);

        DateTimeFormatter formatterGR = DateTimeFormatter.ofPattern("dd.MMMM.yyyy", Locale.GERMAN);
        String formatGR = LocalDate.now().format(formatterGR);
        System.out.println(formatGR);
        LocalDate parserGR = LocalDate.parse("19.Februar.2021", formatterGR);
